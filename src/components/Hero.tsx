...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-dark text-white py-20 px-4">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <h1 className="text-4xl md:text-6xl font-bold font-mono leading-tight overflow-hidden whitespace-nowrap animate-text-reveal">
